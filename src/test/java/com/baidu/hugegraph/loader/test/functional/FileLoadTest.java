...
public class FileLoadTest extends LoadTest {
    ...
    @Test
    public void testBatchUpdateElementWithEmptyStrategy() {
        ioUtil.write("vertex_person.txt",
                     "tom\t18\t[str1,str2]",
                     "tom\t25\t[str1,str3]");

        String[] args = new String[]{
                "-f", configPath("update_by_empty_strategy/struct.json"),
                "-s", configPath("update_by_empty_strategy/schema.groovy"),
                "-g", GRAPH,
                "-h", SERVER,
                "--num-threads", "2",
                "--test-mode", "true"
